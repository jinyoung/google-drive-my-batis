...
@Service
@KafkaListener(topics = "google.drive", groupId = "videoProcessing", containerFactory = "kafkaListenerContainerFactory",contentTypeConverter="smartMessageConverter")
public class PolicyHandler {
    ...
    @KafkaHandler
    public void wheneverFileUploaded_ProcessVideo(@Payload FileUploaded fileUploaded, Acknowledgment acknowledgment,
    ...
    @KafkaHandler
    public void wheneverFileDeleted_DeleteVideo(@Payload FileDeleted fileDeleted, Acknowledgment acknowledgment,
                                            @Nullable @Header(KafkaHeaders.RECEIVED_PARTITION_ID) Integer partition,
                                            @Nullable @Header(KafkaHeaders.RECEIVED_MESSAGE_KEY) String messageKey){
